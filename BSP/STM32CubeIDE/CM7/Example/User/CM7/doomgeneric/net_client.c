...
static __attribute__((section(".ramd3"))) net_server_send_t send_queue[BACKUPTICS];

// Receive window

static __attribute__((section(".ramd3"))) ticcmd_t recvwindow_cmd_base[NET_MAXPLAYERS];
static int recvwindow_start;
static __attribute__((section(".ramd3"))) net_server_recv_t recvwindow[BACKUPTICS];
