...
static __attribute__((section(".ramd2"))) net_server_state_t server_state;
static boolean server_initialized = false;
static __attribute__((section(".ramd2"))) net_client_t clients[MAXNETNODES];
static __attribute__((section(".ramd2"))) net_client_t *sv_players[NET_MAXPLAYERS];
