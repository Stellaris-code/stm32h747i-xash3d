...
__attribute__((section(".extram.misc"))) char			cl_textbuffer[MAX_TEXTCHANNELS][2048];
...
#if XASH_WIN32 && !XASH_64BIT && false
...
#else
	void Initialize(); clgame.dllFuncs.pfnInitialize = Initialize;
	void HUD_VidInit(); clgame.dllFuncs.pfnVidInit = HUD_VidInit;
	void HUD_Init(); clgame.dllFuncs.pfnInit = HUD_Init;
	void HUD_Shutdown(); clgame.dllFuncs.pfnShutdown = HUD_Shutdown;
	void HUD_Redraw(); clgame.dllFuncs.pfnRedraw = HUD_Redraw;
	void HUD_UpdateClientData(); clgame.dllFuncs.pfnUpdateClientData = HUD_UpdateClientData;
	void HUD_Reset(); clgame.dllFuncs.pfnReset = HUD_Reset;
	void HUD_PlayerMove(); clgame.dllFuncs.pfnPlayerMove = HUD_PlayerMove;
	void HUD_PlayerMoveInit(); clgame.dllFuncs.pfnPlayerMoveInit = HUD_PlayerMoveInit;
	void HUD_PlayerMoveTexture(); clgame.dllFuncs.pfnPlayerMoveTexture = HUD_PlayerMoveTexture;
	void HUD_ConnectionlessPacket(); clgame.dllFuncs.pfnConnectionlessPacket = HUD_ConnectionlessPacket;
	void HUD_GetHullBounds(); clgame.dllFuncs.pfnGetHullBounds = HUD_GetHullBounds;
	void HUD_Frame(); clgame.dllFuncs.pfnFrame = HUD_Frame;
	void HUD_PostRunCmd(); clgame.dllFuncs.pfnPostRunCmd = HUD_PostRunCmd;
	void HUD_Key_Event(); clgame.dllFuncs.pfnKey_Event = HUD_Key_Event;
	void HUD_AddEntity(); clgame.dllFuncs.pfnAddEntity = HUD_AddEntity;
	void HUD_CreateEntities(); clgame.dllFuncs.pfnCreateEntities = HUD_CreateEntities;
	void HUD_StudioEvent(); clgame.dllFuncs.pfnStudioEvent = HUD_StudioEvent;
	void HUD_TxferLocalOverrides(); clgame.dllFuncs.pfnTxferLocalOverrides = HUD_TxferLocalOverrides;
	void HUD_ProcessPlayerState(); clgame.dllFuncs.pfnProcessPlayerState = HUD_ProcessPlayerState;
	void HUD_TxferPredictionData(); clgame.dllFuncs.pfnTxferPredictionData = HUD_TxferPredictionData;
	void HUD_TempEntUpdate(); clgame.dllFuncs.pfnTempEntUpdate = HUD_TempEntUpdate;
	void HUD_DrawNormalTriangles(); clgame.dllFuncs.pfnDrawNormalTriangles = HUD_DrawNormalTriangles;
	void HUD_DrawTransparentTriangles(); clgame.dllFuncs.pfnDrawTransparentTriangles = HUD_DrawTransparentTriangles;
	void HUD_GetUserEntity(); clgame.dllFuncs.pfnGetUserEntity = HUD_GetUserEntity;
	void Demo_ReadBuffer(); clgame.dllFuncs.pfnDemo_ReadBuffer = Demo_ReadBuffer;
	void CAM_Think(); clgame.dllFuncs.CAM_Think = CAM_Think;
	clgame.dllFuncs.CL_IsThirdPerson = CL_IsThirdPerson;
	void CL_CameraOffset(); clgame.dllFuncs.CL_CameraOffset = CL_CameraOffset;
	void CL_CreateMove(); clgame.dllFuncs.CL_CreateMove = CL_CreateMove;
	void CLDLL_IN_ActivateMouse(); clgame.dllFuncs.IN_ActivateMouse = CLDLL_IN_ActivateMouse;
	void CLDLL_IN_DeactivateMouse(); clgame.dllFuncs.IN_DeactivateMouse = CLDLL_IN_DeactivateMouse;
	void CLDLL_IN_MouseEvent(); clgame.dllFuncs.IN_MouseEvent = CLDLL_IN_MouseEvent;
	void CLDLL_IN_Accumulate(); clgame.dllFuncs.IN_Accumulate = CLDLL_IN_Accumulate;
	void IN_ClearStates(); clgame.dllFuncs.IN_ClearStates = IN_ClearStates;
	void V_CalcRefdef(); clgame.dllFuncs.pfnCalcRefdef = V_CalcRefdef;
	void KB_Find(); clgame.dllFuncs.KB_Find = KB_Find;
#endif
...
#else
	void HUD_GetStudioModelInterface(); clgame.dllFuncs.pfnGetStudioModelInterface = HUD_GetStudioModelInterface;
	void HUD_DirectorMessage(); clgame.dllFuncs.pfnDirectorMessage = HUD_DirectorMessage;
	void HUD_VoiceStatus(); clgame.dllFuncs.pfnVoiceStatus = HUD_VoiceStatus;
	//void HUD_GetRenderInterface(); clgame.dllFuncs.pfnGetRenderInterface = HUD_GetRenderInterface;
	//void IN_ClientTouchEvent(); clgame.dllFuncs.pfnTouchEvent = IN_ClientTouchEvent;
	void IN_ClientMoveEvent(); clgame.dllFuncs.pfnMoveEvent = IN_ClientMoveEvent;
	void IN_ClientLookEvent(); clgame.dllFuncs.pfnLookEvent = IN_ClientLookEvent;
#endif
