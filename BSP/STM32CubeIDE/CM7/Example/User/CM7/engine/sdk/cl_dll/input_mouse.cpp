...
extern "C" void DLLEXPORT CLDLL_IN_ActivateMouse( void )
{
	currentInput->IN_ActivateMouse();
}

extern "C" void DLLEXPORT CLDLL_IN_DeactivateMouse( void )
{
	currentInput->IN_DeactivateMouse();
}

extern "C" void DLLEXPORT CLDLL_IN_MouseEvent(int mstate)
{
	currentInput->IN_MouseEvent(mstate);
}

extern "C" void DLLEXPORT CLDLL_IN_Accumulate( void )
{
