...
#define MAX_DECALS		64	// touching TE_DECAL messages, etc
#define MAX_STATIC_ENTITIES	16	// static entities that moved on the client when level is spawn
#endif
