...
__attribute__((section(".extram.misc"))) portable_samplepair_t	streambuffer[(PAINTBUFFER_SIZE+1)];
__attribute__((section(".extram.misc"))) portable_samplepair_t	paintbuffer[(PAINTBUFFER_SIZE+1)];
__attribute__((section(".extram.misc"))) portable_samplepair_t	roombuffer[(PAINTBUFFER_SIZE+1)];
__attribute__((section(".extram.misc"))) portable_samplepair_t	facingbuffer[(PAINTBUFFER_SIZE+1)];
__attribute__((section(".extram.misc"))) portable_samplepair_t	temppaintbuffer[(PAINTBUFFER_SIZE+1)];
__attribute__((section(".extram.misc"))) paintbuffer_t		paintbuffers[CPAINTBUFFERS];

__attribute__((section(".extram.sndtable"))) int			snd_scaletable[SND_SCALE_LEVELS][256];
