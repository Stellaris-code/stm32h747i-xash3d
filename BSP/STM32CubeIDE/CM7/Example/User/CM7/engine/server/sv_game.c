...
{
	return GetEntitySpawnCallback(pszClassName);
...
void EXPORT2 GiveFnptrsToDll(enginefuncs_t* pengfuncsFromEngine, globalvars_t* pGlobals);

__attribute__((section(".extram.vid"))) playermove_t		gpMove;
