...
__attribute__((section(".extram.vid"))) client_t		cl;
__attribute__((section(".ramd1.vid"))) client_static_t	cls;
__attribute__((section(".extram.vid"))) clgame_static_t	clgame;
