...
C_SRCS += \
../Example/User/CM7/engine/platform/fatfs/diskio.c \
../Example/User/CM7/engine/platform/fatfs/ff.c \
../Example/User/CM7/engine/platform/fatfs/ffsystem.c \
../Example/User/CM7/engine/platform/fatfs/ffunicode.c 

C_DEPS += \
./Example/User/CM7/engine/platform/fatfs/diskio.d \
./Example/User/CM7/engine/platform/fatfs/ff.d \
./Example/User/CM7/engine/platform/fatfs/ffsystem.d \
./Example/User/CM7/engine/platform/fatfs/ffunicode.d 

OBJS += \
./Example/User/CM7/engine/platform/fatfs/diskio.o \
./Example/User/CM7/engine/platform/fatfs/ff.o \
./Example/User/CM7/engine/platform/fatfs/ffsystem.o \
./Example/User/CM7/engine/platform/fatfs/ffunicode.o 


# Each subdirectory must supply rules for building sources it contributes
Example/User/CM7/engine/platform/fatfs/%.o Example/User/CM7/engine/platform/fatfs/%.su Example/User/CM7/engine/platform/fatfs/%.cyclo: ../Example/User/CM7/engine/platform/fatfs/%.c Example/User/CM7/engine/platform/fatfs/subdir.mk
...
clean: clean-Example-2f-User-2f-CM7-2f-engine-2f-platform-2f-fatfs

clean-Example-2f-User-2f-CM7-2f-engine-2f-platform-2f-fatfs:
	-$(RM) ./Example/User/CM7/engine/platform/fatfs/diskio.cyclo ./Example/User/CM7/engine/platform/fatfs/diskio.d ./Example/User/CM7/engine/platform/fatfs/diskio.o ./Example/User/CM7/engine/platform/fatfs/diskio.su ./Example/User/CM7/engine/platform/fatfs/ff.cyclo ./Example/User/CM7/engine/platform/fatfs/ff.d ./Example/User/CM7/engine/platform/fatfs/ff.o ./Example/User/CM7/engine/platform/fatfs/ff.su ./Example/User/CM7/engine/platform/fatfs/ffsystem.cyclo ./Example/User/CM7/engine/platform/fatfs/ffsystem.d ./Example/User/CM7/engine/platform/fatfs/ffsystem.o ./Example/User/CM7/engine/platform/fatfs/ffsystem.su ./Example/User/CM7/engine/platform/fatfs/ffunicode.cyclo ./Example/User/CM7/engine/platform/fatfs/ffunicode.d ./Example/User/CM7/engine/platform/fatfs/ffunicode.o ./Example/User/CM7/engine/platform/fatfs/ffunicode.su

.PHONY: clean-Example-2f-User-2f-CM7-2f-engine-2f-platform-2f-fatfs
