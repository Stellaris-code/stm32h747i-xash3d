...
typedef void(*entity_callback_t)(entvars_t*);

#ifdef __cplusplus

extern size_t entity_map_counter;
extern const char* entity_map_names[8192];
extern entity_callback_t entity_map_funcs[8192];
struct EntityMap
{
	EntityMap(const char* name, entity_callback_t func);
};

extern "C" entity_callback_t GetEntitySpawnCallback(const char* name);
#else
extern entity_callback_t GetEntitySpawnCallback(const char* name);
#endif

#if CLIENT_DLL
#define LINK_ENTITY_TO_CLASS(mapClassName,DLLClassName)
#else // CLIENT_DLL
#define LINK_ENTITY_TO_CLASS(mapClassName,DLLClassName) static EntityMap mapClassName (#mapClassName, (entity_callback_t)(void*)&GetClassPtr<DLLClassName>);
#endif // CLIENT_DLL
