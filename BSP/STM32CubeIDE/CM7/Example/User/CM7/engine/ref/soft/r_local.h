...
void soft_Mod_LoadSpriteModel( model_t *mod, const void *buffer, qboolean *loaded, uint texFlags );
...
// renderer exports
//
qboolean soft_R_Init( void );
void soft_R_Shutdown( void );
...
void R_ClearScene( void );
void soft_R_GetTextureParms( int *w, int *h, int texnum );
...
void TriEnd( void );
void TriTexCoord2f_impl( float u, float v );
...
int soft_TriSpriteTexture( model_t *pSpriteModel, int frame );
...
extern ref_globals_t *gpGlobals asm("ref_gpGlobals");
